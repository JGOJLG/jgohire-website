    ...
    content: (
      <>
        <div className="profile-photo-image">
          <Image
            src="/course/profile-photo.png"
            alt="LinkedIn profile photo example"
            width={1600}
            height={900}
            className="profile-photo-image-img"
            priority
          />
        </div>
    ...
    content: (
      <>
        <aside className="profile-photo-warning-card">
          ...
          <h3>
            Do Not Use a Fully AI-Generated Photo
          </h3>

          <p>
            I know, I just spent time telling you to use AI. Bear with me on this one.
          </p>
          ...
          <p>
            There is a significant amount of fraudulent activity happening on LinkedIn right now. You are probably already seeing it on the job seeker side with fake postings and ghost jobs, but it exists on the recruiter side too.
          </p>

          <p>
            Fake profiles are everywhere. Some are built to scrape information. Others are used to apply to roles in bulk. Because many fraudulent profiles use AI-generated photos, recruiters have become more skeptical when something looks slightly off.
          </p>

          <p>
            It creates the same hesitation as having no photo at all, using a cartoon image, or uploading a cropped group shot. It is simply not professional.
          </p>
        </aside>
    ...
    content: (
      <>
        <div className="profile-photo-reading-card">
          ...
          <p>
            AI can be useful for small enhancements. Clean up the background, improve the lighting, or make the image look a bit more polished.
          </p>

          <p>
            Just be careful. Sometimes AI alters your face and it no longer looks like you.
          </p>
        </div>
        ...
        <div className="profile-photo-support-grid">
          <article>
            ...
            <p>
              Clean up the background, improve lighting, or make subtle professional improvements.
            </p>
          </article>
          ...
          <article>
            ...
            <h3>Be Careful</h3>
            <p>
              Your photo should still look like you. Authenticity matters.
            </p>
          </article>
        </div>
      </>
...

  {
    ...
    content: (
      <>
        <div className="profile-photo-reading-card">
          <p>
            Go outside, use natural lighting, wear something you would actually wear to work, and have someone take the photo.
          </p>

          <p>
            Start with a real photo of you. From there, AI enhancements are fair game.
          </p>
        </div>
        ...
        <aside className="profile-photo-final-card">
          ...
          <p>
            Whatever you do, do not use a fully AI-generated photo.
          </p>
        </aside>
      </>
    ),
